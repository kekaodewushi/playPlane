...
import com.game.server.Award;
import com.game.server.Enemy;
...
public class ShootGame extends JPanel {
    ...
    public void paintMSG(Graphics g) {
        ...
        int y = 80; // y坐标
        Font font = new Font(Font.SANS_SERIF, Font.BOLD, 22); // 字体
        g.setColor(new Color(0xFF6267));
        g.setFont(font); // 设置字体
        g.drawString(MSG, x, y); // 画分数
    }
    /**
     * 画游戏状态
     */
    ...
    public void shootAction() {
        shootIndex++;
        System.out.println(shootIndex);
        System.out.println(hero.getSpeedFire());
        if (shootIndex % hero.getSpeedFire() == 0) { // 300毫秒发一颗
            ...
            if (one instanceof Enemy) { // 检查类型，是敌人，则加分
                ...
                switch (type) {
                    case Award.DOUBLE_FIRE:
                        MSG="双倍火力来袭~~";
                        hero.addDoubleFire(Award.DOUBLE_FIRE); // 设置双倍火力
                        break;
                    case Award.THREE_FIRE:
                        MSG="三倍火力来袭~~";
                        hero.addDoubleFire(Award.THREE_FIRE); // 设置多倍火力
                        break;
                    case Award.SPEED_DOUBLE_FIRE:
                        MSG="双级射速来袭~~";
                        hero.addDoubleFire(Award.SPEED_DOUBLE_FIRE); // 设置多倍火力
                        break;
                    case Award.SPEED_THREE_FIRE:
                        MSG="三级射速来袭~~";
                        hero.addDoubleFire(Award.SPEED_THREE_FIRE); // 设置多倍火力
                        break;
                    case Award.SPEED_FOUR_FIRE:
                        MSG="超级来袭~~";
    ...
    public static FlyingObject nextOne() {
        ...
        return type < 4 ? new Bee() : new Airplane();
    }
}
